...
"services": {
"family-estate-planning.md": {
	id: "family-estate-planning.md";
...
"young-professionals-and-student-estate-planning.md": {
	id: "young-professionals-and-student-estate-planning.md";
  slug: "young-professionals-and-student-estate-planning";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
